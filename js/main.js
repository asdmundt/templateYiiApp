...
var floatieheight="350px" //default height of floatie in px. Set to "" to let floatie content dictate height.
...
function showfloatie(thetext, e, optbgColor, optWidth, optHeight,dsocx,dsocy){
//var dsocx=(window.pageXOffset)? pageXOffset: ietruebody().scrollLeft;
//var dsocy=(window.pageYOffset)? pageYOffset : ietruebody().scrollTop;
var floatobj=document.getElementById("dhtmlfloatie")
floatobj.style.left="-900"
