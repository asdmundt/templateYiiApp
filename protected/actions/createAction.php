...
class CreateAction extends CAction
{
  ...
  /**
   * @var string name of the master model to build e.g. kontakte._.id
   */
  protected $_nameMasterModel = '';
  
    /**
   * @var string name of the master model to build e.g. $_nameMasterModel.'_id'
   */
  public $nameMasterKey = '';
  
    /**
   * @var int value of the master model id
   */
  public $idMasterModel = 0 ;
  ...
  protected function init()
  {
    ...
    if( isset( $_GET['mid'] ) ){
        $this->idMasterModel = $_GET['mid'];
        $this->nameMasterKey = $_GET['nameMasterKey'];
    }
  ...
  public function run()
  {
    ...
    $model = new $modelClass();
     if(( $this->idMasterModel > 0 ) && ($model->hasAttribute($this->nameMasterKey))){
         Yii::log('!createAction::$this->nameMasterKey '.$this->nameMasterKey, 'info', 'application');
         Yii::log('!createAction::$this->idMasterModel '.$this->idMasterModel, 'info', 'application');
       $model->setAttribute($this->nameMasterKey,$this->idMasterModel);
    }
