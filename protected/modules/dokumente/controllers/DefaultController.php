...
class DefaultController extends Controller
{
	...
	public function actionIndex()
    {
        ...
        if(isset($_POST['DDMediaAction'])) {
            ...
            Yii::log('DefaultController:actionIndex:var_dump($mediaAction->attributes)= '.var_dump($mediaAction->attributes), 'info', 'application');
        ...
        try {
            ...
            echo $this->renderPartial('_mediagrid', array(
