...
class SftpComponent extends CApplicationComponent
{
	 ...
	 */
	public function listFiles($directory = '.', $showHiddenfiles = false,$stats = true)
	{
		...
		foreach($res_files as $file)
		{
			...
			if($stats){
                            ...
                            "mimeType" => '',
                            "size" => $this->getFileStat($file, 'size'),
                             "directory" => $directory,
                            "modified" =>  $this->getFileStat($file, 'mtime'),
                             "owner" =>  $this->getFileStat($file, 'uid').' '.$this->getFileStat($file, 'gid'),   
                            "permissions" => '',
                        );
                        $i++;    
                        }else{
