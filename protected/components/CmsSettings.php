...
class CmsSettings extends CApplicationComponent
{
    ...
    public function init()
    {
        ...
        if(!Yii::app()->user->isGuest)
           $this->_userStr = Yii::app()->user->id.'_'.Yii::app()->user->name;
        
	if(!$this->_global){
            $this->_tableName = '{{'.$this->_userStr.'}}';
            $this->_cacheId = $this->_userStr;
        }	
